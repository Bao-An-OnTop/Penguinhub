...
-- Khung chính (Màu xanh dương đẹp)
UI["2"] = Instance.new("Frame", UI["1"])
UI["2"].BorderSizePixel = 0
UI["2"].BackgroundColor3 = Color3.fromRGB(0, 120, 215) -- Xanh dương đậm hơn một chút
...
-- Viền Stroke (Màu xanh dương đậm hơn)
local UIStroke = Instance.new("UIStroke", UI["2"])
UIStroke.Thickness = 5
UIStroke.Color = Color3.fromRGB(0, 90, 180) -- Xanh dương mạnh hơn
